...
// Tue Aug  7 17:34:35 2018 by ROOT version 6.12/06
// from TTree Delphes/Analysis tree
// found on file: tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef SMCEDM_Analysis_h
#define SMCEDM_Analysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3721;
   static constexpr Int_t kMaxTrack = 178;
   static constexpr Int_t kMaxTower = 302;
   static constexpr Int_t kMaxEFlowTrack = 178;
   static constexpr Int_t kMaxEFlowPhoton = 109;
   static constexpr Int_t kMaxEFlowNeutralHadron = 165;
...
SMCEDM_Analysis::~SMCEDM_Analysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SMCEDM_Analysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SMCEDM_Analysis::LoadTree(Long64_t entry)
{
...
void SMCEDM_Analysis::Init(TTree *tree)
{
...
void SMCEDM_Analysis::Show(Long64_t entry)
{
...
Int_t SMCEDM_Analysis::Cut(Long64_t entry)
{
...
#endif // #ifdef SMCEDM_Analysis_cxx
